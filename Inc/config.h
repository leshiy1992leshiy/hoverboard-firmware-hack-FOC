...
#define DEFAULT_SPEED_COEFFICIENT   2000 // Default for SPEED_COEFFICIENT 1.0f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case 16384 = 1.0 * 2^14
...
*/
  // #define DUAL_INPUTS                     // ADC*(Primary) + PWM(Auxiliary). Uncomment this to use Dual-inputs
    ...
    #define PRI_INPUT1            3, -4000, 0, 4000, 30  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define PRI_INPUT2            3, -4000, 0, 4000, 30  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #endif
